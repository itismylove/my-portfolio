...
export default function index() {
    return <>
    <Head>
        <title>Vitruk Dmytro | Senior Frontend Engineer</title>
        <meta name="viewport" content="initial-scale=1.0, width=device-width" />
        <meta name="description" content="Vitruk Dmytro's portfolio. I solve problems using code (Mostly web). Engineer from Somewhere and everywhere."/>
